                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="purpose" id="purpose" required>
                                ...
                                <option value="{{ $purpose->id }}" @if( $purpose->id == $row->purpose_id ) selected @endif>{{ $purpose->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="visit_from" id="visit_from" value="{{ $row->visit_from }}">
