...
<div id="addModal-{{ $row->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <form class="needs-validation" novalidate action="{{ route($route.'.store', $row->id) }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" name="bonus" id="bonus" value="{{ round($bonus, 0) }}" required data_id="add-{{ $row->id }}" onkeyup="salaryCalculator('add', {{ $row->id }})">
                    ...
                    <input type="text" name="deduction_salary" value="{{ round($deduction_salary, 0) }}" hidden data_id="add-{{ $row->id }}" onkeyup="salaryCalculator('add', {{ $row->id }})">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-success"><i class="fas fa-plus"></i> {{ __('btn_create') }}</button>
            </div>
