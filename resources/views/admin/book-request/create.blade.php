                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control autonumber" name="quantity" id="quantity" value="{{ old('quantity') }}" data-v-max="999999999" data-v-min="0">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="request_by" id="request_by" value="{{ old('request_by') }}" required>
