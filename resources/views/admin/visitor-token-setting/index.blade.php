                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                          <div class="row">
                            ...
                            <input name="slug" type="hidden" value="visitor-token">
                            ...
                            <div class="form-group col-md-6 mt-4">
                                <div class="switch d-inline m-r-10">
                                    <input type="checkbox" id="barcode" name="barcode" value="1" @if(isset($row->barcode)) @if($row->barcode == 1) checked @endif @else checked @endif>
