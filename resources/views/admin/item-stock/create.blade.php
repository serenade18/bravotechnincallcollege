                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="supplier" id="supplier" required>
                                ...
                                <option value="{{ $supplier->id }}" @if(old('supplier') == $supplier->id) selected @endif>{{ $supplier->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <select class="form-control" name="store" id="store" required>
                                ...
                                <option value="{{ $store->id }}" @if(old('store') == $store->id) selected @endif>{{ $store->title }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control autonumber" name="price" id="price" value="{{ old('price') }}" required>
