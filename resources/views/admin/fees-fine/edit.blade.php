                    ...
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="start_day" id="start_day" value="{{ $row->start_day }}" required data-v-max="999999999" data-v-min="0">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="end_day" id="end_day" value="{{ $row->end_day }}" required data-v-max="999999999" data-v-min="0">
